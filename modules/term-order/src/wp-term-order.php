...
final class WP_Term_Order {
	...
	public function __construct() {
		...
		foreach ( $taxonomies as $value ) {
			...
			//Modification Game On remove next 2 line
	...
	public function admin_head() {
		...
		<style type="text/css">
			...
			*/
			...
			.container, .the-list-header div, .the-list-footer div  {
			  display: -webkit-flex;
			  display: flex;
			}
			
			.handleLeft, .handleRight, .handleRight_nograb {
				-webkit-flex: none;
				flex: none;
			  	width: 25px;
			  	padding: 5px;
			  	text-align: center;
			  	background: rgba(39,62,84,0.15);	
			}
			...
			.name, #name, .manage-column:nth-child(3) {
			  -webkit-flex: none;
					  flex: none;
			  width: 200px;
			}
			.posts, #posts, .manage-column:nth-child(4) {
			  -webkit-flex: 1;
					  flex: 1;
			}
			.pod_toggle, #pod_toggle, .manage-column:nth-child(5) {
			  -webkit-flex: 1;
					  flex: 1;
			}
			.pod_achievement, #pod_achievement, .manage-column:nth-child(6) {
			  -webkit-flex: 1;
					  flex: 1;
			}
			
			.ulSortable {cursor: move;}
			
			.the-list-header {border-bottom-style: solid; border-color: #aaa; background-color: #eee; } 
			.the-list-footer {border-top-style: solid; border-color: #aaa; padding-top:10px; background-color: #eee;} 

			.parent {background-color:lightblue;}
			.child:nth-child(even) {background-color: #f9f9f9;}
