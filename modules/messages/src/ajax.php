           ...
           //BUILD THE RESET MESSAGE WINDOW TOP WITH A LIST OF TASKS AND USERS
            ...
            <div id="go_messages" style="display:flex;">
                ...
                <div id="messages_form" style="text-align: left;">
                    ...
                    <label for="go_additional_penalty_toggle">Assign Penalty </label><span class="tooltip" data-tippy-content="In addition to removing loot that had been awarded, you may assign an additional penalty."><span><i class="fa fa-info-circle"></i></span></span>
                                            ...
                                            <div class="go-acf-input">
                                                <table class="go-acf-table">
                                                    ...
                                                    <tr class="go-acf-row">
                                                        ...
                                                        <div class="go-acf-input">
                                                            <div class="go-acf-input-wrap"><input name="xp" type="number"
                                                                                                  value="" min="0" step="1" placeholder="0" class="xp_messages" oninput="validity.valid||(value='');">
                                                            </div>
                                                        </div>
                                                        </td>
                                                        <td class="go-acf-field go-acf-field-number go_reward go_gold"
                                                        ...
                                                        <td class="go-acf-field go-acf-field-number go_reward go_health "
                                                            ...
                                                            <div class="go-acf-input">
                                                                <div class="go-acf-input-wrap"><input name="health"
                                                                                                      type="number" value=""
                                                                                                      min="0" step=".01" placeholder="0" class="health_messages" oninput="validity.valid||(value='');"></div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
//reset stage
    ...
    if($penalty == 'true') {
        ...
        if (($xp != 0) || ($gold != 0) || ($health != 0) || count($badge_array) > 0 || count($group_array) > 0) {
            $penalty_message = "<br><br>Additional Penalty:" . $xp_p_message . $gold_p_message . $health_p_message . $badge_p_message . $group_p_message;
        }
...
function go_send_message(){
    ...
    foreach ($reset_vars as $vars){
        ...
        //update actions
        go_update_actions($user_id, $type, $task_id, 1, null, null, $result, null, null, null, null, $xp, $gold, $health, $badge_ids, $group_ids, false, false);
    }
