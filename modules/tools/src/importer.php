<?php
/*
Plugin Name: Gameful Importer
Plugin URI: http://gameful.me
Description: Import posts, pages, comments, custom fields, categories, tags and more from a WordPress export file.
Author: Mick
Author URI: http://gameful.me
Version: 0.6.4
Text Domain: gameful-importer
 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
    class WP_GO_Import extends WP_Importer {
        ...
        function get_import_data() {
            ...
            if ( $import_host == $my_host ) {
                ...
                echo '<p><strong>' . __( 'Sorry, there has been an error.', 'wordpress-importer' ) . '</strong><br />';
                echo ( __( 'You must input a URL. ', 'wordpress-importer' ));
                echo '</p>';
                return false;
            }
        ...
        function header() {
            echo '<div class="wrap">';
            echo '<h2>' . __( 'Import Game Data', 'gameful-importer' ) . '</h2>';
            ...
            if ( isset( $updates[$basename] ) ) {
                ...
                echo '<div class="error"><p><strong>';
                printf( __( 'A new version of this importer is available. Please update to version %s to ensure compatibility with newer export files.', 'gameful-importer' ), $update->update->new_version );
                echo '</strong></p></div>';
            }*/
        }
        ...
        function greet() {
            ...
            echo '<p>'.__( 'Input your import link from another game and we&#8217;ll import the maps, store items, badges, and groups into this site.', 'gameful-importer' ).'</p>';
            //wp_import_upload_form( 'admin.php?import=gameful&amp;step=1' );
            $action = 'admin.php?import=gameful&amp;step=1';
            ?>
            <form enctype="multipart/form-data" id="import-url-form" method="post" class="go-upload-form" action="<?php echo esc_url( wp_nonce_url( $action, 'import-upload' ) ); ?>">
                <input type="text" name="import_url" value="" /><br />
                <?php submit_button( __( 'Import Game Data' ), 'primary' ); ?>
            </form>
            <?php
            echo '</div>';
        }
...
function gameful_importer_init() {
    load_plugin_textdomain( 'gameful-importer' );

    /**
     * WordPress Importer object for registering the import callback
     * @global WP_Import $wp_import
     */
    $GLOBALS['wp_import'] = new WP_GO_Import();
