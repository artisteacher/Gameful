...
get_header();
 ...
 if ($this_page == 'new_avatar'){
    echo '<div class="acf-notice">You can change your avatar below.</div>';
...
*/
    ...
    if ($this_page == 'profile'){
        ...
        if($activate){
            ...
            $form =  go_acf_user_form_func($groups, $fields, 'activate_user', get_site_url(null, '/profile'));
            echo $form;
            $block_form = true;
            echo "</div></div>";
        }
