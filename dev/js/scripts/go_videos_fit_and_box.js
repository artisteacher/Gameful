...
function go_Vids_Fit_and_Box (fit_element){
    //
    console.log("go_Vids_Fit_and_Box here");
...
function go_video_resize(){
    ...
    var VratioH = jQuery('.fit_and_box .featherlight-content .fluid-width-video-wrapper').css('padding-top');
    var VratioW = jQuery('.fit_and_box .featherlight-content .fluid-width-video-wrapper').css('width');
    ...
    jQuery(".fit_and_box .featherlight-content").css('width', contentWidth);
    jQuery(".fit_and_box .featherlight-content").css('height', contentHeight);
...
//console.log("max_width");
    ...
    if (jQuery("#go_cards").length ) {
        jQuery("#go_cards").masonry('reloadItems').masonry('layout');
    }
 }

function go_LightboxNow(){
    console.log ("go_LightboxNow");
    ...
    jQuery('[class^="featherlight_wrapper_iframe"]').each(function(){
        ...
        jQuery('.featherlight_wrapper_iframe').featherlight({
            ...
            afterOpen: function(event){
                ...
                jQuery(".fit_and_box .featherlight-content").css({
                    //jQuery(this).css({
                    'width' : '100%',
                    'overflow' : 'hidden'
                });
                //jQuery(".featherlight-content iframe").src().append( "&autoplay=1");
                jQuery(".fit_and_box .featherlight-content iframe").attr('src' , jQuery(".fit_and_box .featherlight-content iframe").attr('src') + "&autoplay=1");
